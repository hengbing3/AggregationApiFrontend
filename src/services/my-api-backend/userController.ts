...
/** 编辑个人信息 PUT /api/myUserInfo */
export async function updateMyUserInfoUsingPut(
  body: API.MyUserUpdateParam,
  options?: { [key: string]: any },
) {
  return request<API.CommonResultVoid>('/api/myUserInfo', {
    method: 'PUT',
    headers: {
...
/** 获取用户访问密钥 GET /api/user/accessKey */
export async function getUserAccessKeyUsingGet(options?: { [key: string]: any }) {
  return request<API.CommonResultUserCertificateVO>('/api/user/accessKey', {
    method: 'GET',
    ...(options || {}),
  });
}

/** 更新用户凭证 PUT /api/user/accessKey */
export async function updateUserAccessKeyUsingPut(options?: { [key: string]: any }) {
  return request<API.CommonResultVoid>('/api/user/accessKey', {
    method: 'PUT',
    ...(options || {}),
  });
}
